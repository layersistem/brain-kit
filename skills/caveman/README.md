...
Bundled with brain-kit as an optional skill: terse output means more of the context window is
left for recall injections. Nothing in the memory engine depends on it — delete the folder if
you prefer normal prose.
